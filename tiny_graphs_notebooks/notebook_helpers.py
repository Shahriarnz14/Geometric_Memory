...
from tiny_graphs_notebooks.experiment_utils import compute_topk_recovery_percent
from tiny_graphs_notebooks.core.analysis import (
...
def _tiny_notebook_artifact_root() -> Path:
    ...
    return Path(__file__).resolve().parent / "saved_artifacts"
