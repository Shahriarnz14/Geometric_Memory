...
from tiny_graphs_notebooks.core.analysis_curves import (
    compute_associative_geometric_curves,
    plot_associative_vs_geometric_curves,
)
from tiny_graphs_notebooks.core.analysis_plots import (
...
from tiny_graphs_notebooks.core.analysis_reduction import (
...
from tiny_graphs_notebooks.core.analysis_spectral import (
